...
/**
 * Entry point of the 'GenerateStatic' generation module.
 *
 * @generated
 */
public class GenerateStatic extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "generateStatic";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateStatic", };
	 ...
	 * @generated
	 */
	public GenerateStatic(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateStatic(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				GenerateStatic generator = new GenerateStatic(modelURI, folder, arguments);
